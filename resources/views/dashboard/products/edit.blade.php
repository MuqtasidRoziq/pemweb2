<x-layouts.app :title="__('edit product')">
    ...
    <form action="{{ route('products.update', $product->id) }}" method="POST" class="max-w-lg">
        ...
        <div class="mb-4">
            ...
            <flux:input name="name" id="name" placeholder="Enter product name"
        ...
        <div class="mb-4">
            ...
            <flux:input name="slug" id="slug" placeholder="Enter slug (e.g., new-product)"
        ...
        <div class="mb-4">
            ...
            <flux:textarea name="description" id="description" placeholder="Enter product description">
        ...
        <div class="mb-4">
            ...
            <flux:input name="sku" id="sku" placeholder="Enter SKU (e.g., PROD-001)"
        ...
        <div class="mb-4">
            ...
            <flux:select name="product_category_id" id="product_category_id">
                ...
                @foreach ($categories as $category)
                    <option value="{{ $category->id }}" {{ old('product_category_id', $product->product_category_id) == $category->id ? 'selected' : '' }}>{{ $category->name_categories }}
                    </option>
                @endforeach
            </flux:select>
        ...
        <div class="mb-4">
            ...
            <flux:input name="image_url" id="image_url" placeholder="Enter image URL (optional)"
